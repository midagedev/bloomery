...
| E11 | 뜨거운 목록으로 깊이 표 6/1024/4096 + ik 열 — `BLOOMERY_BOX_ENV="BLOOMERY_HOT_LIST=/root/bloomery-data/router/hotlist-384.txt" just depth-gpu-ds41 …` | B12 실측(예측 30–33 ms; 임대 창 H=24.89면 ~28–31) | 임대 ~25분(자리 5) | 리드 | hotset 머지 |
