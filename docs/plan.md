...
| A3b | 활성값 1열 lane 몸통(ILP) + 워프 top-6 — rtr 라운드 | **스텝 4.2755 ms = 233.89 tok/s = ik의 1.080배**(3090, 임대, 리드 재측정 233.79); 남은 것 = 같은 패턴의 K-quant 코어(`cores.rs` `q4k_row_dot`·`q3k_row_dot`, 스텝의 벌크) |
