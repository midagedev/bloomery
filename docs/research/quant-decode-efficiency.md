...
날짜 2026-09-19. `bloomery` 설계 입력용 조사 보고서. 읽기만 했고, 포팅하지 않았다.
...
dense 7.658 GB(VRAM, 가정 500 GB/s → 16.7 ms). 실측 39.92 ms/토큰(25.05 tok/s) — 엔진은 mainline 포크다(2026-09-19 정정: 이 값을 ik로 적어 뒀었다).
