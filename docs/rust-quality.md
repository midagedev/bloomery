...
| 계기 | 값 | 방향 |
|---|---|---|
| `just lint` 경고 | **260** (2026-09-21 아침 144 — 하루 만에 +116); `--features gpu`를 켜면 **308**(gpu-gates 바이너리 17개 본체가 그제야 검사된다 — 리뷰 2026-09-22가 잡은 lint 사각) | 래칫 다운만; 기준 계기는 `--features gpu` 포함 308 |
