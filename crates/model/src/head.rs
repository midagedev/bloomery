...
/// An f32 tensor read straight out of the file. Norm gains are stored unquantized
/// in this model; the byte walk is the same one the ops gate uses on `attn_norm`.
fn read_f32(gguf: &Gguf, t: &TensorInfo) -> Result<Vec<f32>, ModelError> {
