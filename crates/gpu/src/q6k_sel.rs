...
mod q6k_sel_kernels {
    ...
    /// load (warp-uniform), leaving that slot of `y` untouched.
    #[allow(
...
impl Q6kSelKernels {
    ...
    /// `>= n_experts` leaves its slot of `y` untouched. Asynchronous,
