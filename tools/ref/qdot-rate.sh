...
# ik 자신의 x4 커널(build-qdot-ref.sh가 짓는 *_rate 하네스 일곱)과 Rust `qdot-rate`를 같은 CPU 임대
...
IK_RATES="q4k_x4_rate q6k_x4_rate q5f0_rate q5f1_rate q5k_x4_rate iq3xxs_rate mxfp4_x4_rate"
